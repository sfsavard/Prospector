...
public class Prospector : MonoBehaviour
{
    ...
    List<CardProspector> ConvertListCardsToListCardProspectors(List<Card> lCD)
    {
        ...
        {
            tCP = tCD as CardProspector;                   // a This as keyword will attempt to convert a Card to a CardProspector
            lCP.Add(tCP);
        }
        return (lCP);
    }
    ...
    void MoveToDiscard(CardProspector cd)
    {
        ...
        cd.transform.localPosition = new Vector3(
            layout.multiplier.x * layout.discardPile.x, layout.multiplier.y * layout.discardPile.y,
