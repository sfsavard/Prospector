...
public class Card : MonoBehaviour {
    ...
    {                                     // a The white background of the card is on bottom (sOrd). On top of that are all the pips, decorators, face, and so on (sOrd+1). The back is on top so that, when it is visible, it covers the rest (sOrd+2)
        PopulateSpriteRenderers();
